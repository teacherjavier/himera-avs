...
type AvsReader interface {
	...
	GetTaskInfo(opts *bind.CallOpts, taskID uint64) (himera_avs.IAVSManagerTaskInfo, error)
	...
	GetOperatorTaskResponseList(opts *bind.CallOpts, taskID uint64) ([]himera_avs.IAVSManagerOperatorResInfo, error)
}
...
func (r *ChainReader) GtAVSUSDValue(opts *bind.CallOpts) (sdkmath.LegacyDec, error) {
	...
	if err != nil { return sdkmath.LegacyDec{}, err }
